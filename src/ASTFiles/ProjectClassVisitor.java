            ...
            if (node.jjtGetChild(0) instanceof ASTExpressionToken) {
                ...
                if (new_node.getName() != null && new_node.getName().equals("this")
                    ...
                    if (!new_dot_node.getName().equals("length")) {
                        ...
                        if (table != null) {
                            System.out.println("I'm " + new_dot_node.getName() + ". I have "
                                    + new_dot_node.jjtGetNumChildren() + " children");
                            ...
                            System.out
                                    .println("Semantic Error: Function " + new_dot_node.getName() + " doesn't exist.");
                            System.exit(-1);
                        }
                    }
